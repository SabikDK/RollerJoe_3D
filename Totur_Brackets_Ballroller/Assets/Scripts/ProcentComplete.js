...
var ProcentCompleteText : Text;
var totalCoinValue : int;
var CoinsToHundredProcent : int;
...
Debug.Log("WARNING 1229: Procent errer: ALMOST Last Level In USE: " + PlayerPrefs.GetInt("100_levelScore" + GameMaster.version));
}

if (PlayerPrefs.GetInt("105_levelScore" + GameMaster.version) != 0){
Debug.Log("ERROR 1339: Procent Error: Last Level In USE: " + PlayerPrefs.GetInt("105_levelScore" + GameMaster.version));
}

//Skriv procent scoren-------------------

var coinsProNumber : int;
coinsProNumber = totalCoinValue*0.033333;//100/1000;///totalCoinValue; //*100; //100/CoinsToHundredProcent * totalCoinValue/;
ProcentCompleteText.text = "" + coinsProNumber +"% Complete";

Debug.Log("CoinsToHundredProcent="+CoinsToHundredProcent+"  totalCoinValue="+totalCoinValue+"   coinsProNumber="+coinsProNumber);



//ProcentCompleteText.text = "" + totalCoinValue / 100 * CoinsToHundredProcent +"% Complete";
